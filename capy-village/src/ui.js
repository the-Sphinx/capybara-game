...
closetPanel.style.backgroundImage = `url(${import.meta.env.BASE_URL}assets/images/ui_background.png)`;
...
closetFrame.src = `${import.meta.env.BASE_URL}assets/images/ui_frame.png`;
